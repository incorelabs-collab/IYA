                                ...
                                if(val != null) {
                                    switch(index) {
                                        ...
                                        case "DOB":
                                            ...
                                            var modifiedDate = dateSplit[0] + " " + app.getMonth(dateSplit[1]);
                                            kidsBodyString += "<div class='row kidsItems'><div class='col-xs-10 col-sm-11 pull-left'><h4 class='infoTitleLabel'>Date of Birth</h4><h5 class='infoTitleDetail'>"+modifiedDate+"</h5></div><div class='col-xs-2 col-sm-1 pull-right'><span class='glyphicon glyphicon-gift Icon'></span></div></div>";
                                            break;
                                        case "Email":
                                        ...
                                        case "Blood_Group":
                                            ...
                                            break;
                                        case "Marital_Status":
                                            kidsBodyString += "<div class='row kidsItems'><div class='col-xs-10 col-sm-11 pull-left'><h4 class='infoTitleLabel'>Marital Status</h4><h5 class='infoTitleDetail'>"+val+"</h5></div><div class='col-xs-2 col-sm-1 pull-right'><span class='glyphicon glyphicon-heart Icon'></span></div></div>";
                                            break;
                                    }
                                }
                            });
...
$(document).ready(function() {
    app.setCurrentPage("spouseInfo.html");
                                                            ...
                                                            if(val != null) {
                                                                switch(index) {
                                                                    ...
                                                                    case "DOB":
                                                                        var dateSplit = val.split('-');
                                                                        var modifiedDate = dateSplit[0] + " " + app.getMonth(dateSplit[1]);
                                                                        parentBodyString += "<div class='row listItems'><div class='col-xs-10 col-sm-11 pull-left'><h4 class='infoTitleLabel'>Date of Birth</h4><h5 class='infoTitleDetail'>"+modifiedDate+"</h5></div><div class='col-xs-2 col-sm-1 pull-right'><span class='glyphicon glyphicon-gift Icon'></span></div></div>";
                                                                        break;
                                                                    case "Email":
